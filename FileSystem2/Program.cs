...
namespace ConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //     //console.WriteLine(Path.GetFileNameWithoutExtrnsion(file));
            //     //console.WritelIne(Path.GetDirectoryName(file));
            //   var info = new FileInfo(file);

            //   Console.WriteLine($"{ Path.GetFileName(file) }: { info.Lenght } bytes");
            //}

            //string newPath = @"C:\users\opilane\FileSystems\SubFolderC\SubFolderD";
            ...
            //else
            //{
            //    Console.WriteLine("Thedirectory does not exist");
            //    Directory.CreateDirectory(newPath);

            //}

            string[] files = Directory.GetFiles(rootPath);
            string destinationFolder = @"C:\users\opilane\source\repos\demo\FileSystem\SubFolderA\";
